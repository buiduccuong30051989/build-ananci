...
!function (e, t, n) {
  ...
  function i() {
    ...
    for (var u in r) {
      if (r.hasOwnProperty(u)) {
        if (e = [], t = r[u], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) {
          e.push(t.options.aliases[n].toLowerCase());
        }

        for (a = s(t.fn, 'function') ? t.fn() : t.fn, i = 0; i < e.length; i++) {
          o = e[i], c = o.split('.'), 1 === c.length ? Modernizr[c[0]] = a : (!Modernizr[c[0]] || Modernizr[c[0]] instanceof Boolean || (Modernizr[c[0]] = new Boolean(Modernizr[c[0]])), Modernizr[c[0]][c[1]] = a), l.push((a ? '' : 'no-') + c.join('-'));
        }
      }
    }
  }
  ...
  Modernizr.inputtypes = function (e) {
    ...
    return m;
  }(d), i(), a(l), delete c.addTest, delete c.addAsyncTest;
